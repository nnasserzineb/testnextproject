                            ...
                            <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                                <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                    <table className="min-w-full leading-normal">
                                        <thead>
                                            <tr>
                                            <th className="px-5 py-3 border-b-2 border-pink-200 bg-pink-700 text-white text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                                    Number
                                                </th>
                                                <th className="px-5 py-3 border-b-2 border-pink-200 bg-pink-700 text-white text-left text-xs font-semibold  uppercase tracking-wider">
                                                   Account
                                                </th>
                                                <th className="px-5 py-3 border-b-2 border-pink-200 bg-pink-700 text-white text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                                Created At
                                        ...
                                        <tbody>
  {dataCostumerOrders.map((order, index) => (
    <tr key={index}>
